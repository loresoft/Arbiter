...
/// </summary>
public sealed partial class UrlBuilderLegacy
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UrlBuilderLegacy"/> class.
    /// </summary>
    public UrlBuilderLegacy()
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="UrlBuilderLegacy"/> with the specified <paramref name="url"/>.
    /// </summary>
    /// <param name="url">A URL string.</param>
    public UrlBuilderLegacy(string? url)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UrlBuilderLegacy"/> with the specified <paramref name="uri"/>.
    /// </summary>
    /// <param name="uri">An instance of the <see cref="Uri"/> class</param>
    /// <exception cref="ArgumentNullException">uri is null</exception>
    public UrlBuilderLegacy(Uri uri)
    {
        if (uri is null)
    ...
    /// <returns></returns>
    public UrlBuilderLegacy SetScheme(string? value)
    {
        Scheme = value;
    ...
    /// <returns></returns>
    public UrlBuilderLegacy SetUserName(string? value, bool unescape = false)
    {
    ...
    /// <param name="unescape">Converts a url string to its unescaped representation.</param>
    /// <returns></returns>
    public UrlBuilderLegacy SetPassword(string? value, bool unescape = false)
    {
    ...
    /// <returns></returns>
    public UrlBuilderLegacy SetHost(string? value)
    {
        Host = value;
    ...
    /// <returns></returns>
    public UrlBuilderLegacy SetPort(int value)
    {
    ...
    /// <param name="value">The port number.</param>
    /// <returns></returns>
    public UrlBuilderLegacy SetPort(string? value)
    {
    ...
    /// <returns></returns>
    public UrlBuilderLegacy SetFragment(string? value)
    {
        Fragment = value;
        if (Fragment is null)
            return this;
    ...
    /// <returns></returns>
    public UrlBuilderLegacy AppendPath(Uri? path)
    {
        if (path is null)
            return this;
    ...
    /// <param name="path">The path segment to append.</param>
    /// <returns></returns>
    public UrlBuilderLegacy AppendPath(string? path)
    {
        if (path is null)
            return this;
    ...
    /// <param name="path">The path segment to append.</param>
    /// <returns></returns>
    public UrlBuilderLegacy AppendPath<TValue>(TValue? path)
    {
        if (path is null)
            return this;
    ...
    /// <returns></returns>
    public UrlBuilderLegacy AppendPaths(params IEnumerable<string>? paths)
    {
        if (paths is null)
            return this;
    ...
    /// <returns></returns>
    public UrlBuilderLegacy AppendPathFormat(string format, params object[] arguments)
    {
    ...
    public UrlBuilderLegacy AppendPathIf(Func<bool> condition, string? path)
    {
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendPathIf(Func<string?, bool> condition, string? path)
    {
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendPathIf(bool condition, string? path)
    {
        if (!condition)
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendPathIf<TValue>(Func<bool> condition, TValue? path)
    {
        if (condition is null || !condition())
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendPathIf<TValue>(Func<TValue?, bool> condition, TValue? path)
    {
        if (condition is null || !condition(path))
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendPathIf<TValue>(bool condition, TValue? path)
    {
        if (!condition)
            return this;
    ...
    /// <returns></returns>
    public UrlBuilderLegacy SetPath(string? path)
    {
        Path.Clear();
        if (path is null)
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQuery(string name, string? value)
    {
        if (name is null)
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQuery<TValue>(string name, TValue? value)
    {
        if (name is null)
            throw new ArgumentNullException(nameof(name));
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQueries<TValue>(string name, IEnumerable<TValue>? values)
    {
        if (name is null)
            throw new ArgumentNullException(nameof(name));
    ...
    /// <param name="values">The query string values.</param>
    /// <returns></returns>
    public UrlBuilderLegacy AppendQueries<TValue>(IEnumerable<KeyValuePair<string, TValue>>? values)
    {
        if (values is null)
            return this;
    ...
    /// <param name="values">The query string values.</param>
    /// <returns></returns>
    public UrlBuilderLegacy AppendQueries(NameValueCollection? values)
    {
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQueryIf(Func<bool> condition, string name, string? value)
    {
        if (condition is null || !condition())
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQueryIf(Func<string?, bool> condition, string name, string? value)
    {
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQueryIf(bool condition, string name, string? value)
    {
        if (!condition)
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQueryIf<TValue>(Func<bool> condition, string name, TValue? value)
    {
        if (condition is null || !condition())
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQueryIf<TValue>(Func<TValue?, bool> condition, string name, TValue? value)
    {
        if (condition is null || !condition(value))
            return this;
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException">name is <see langword="null"/></exception>
    public UrlBuilderLegacy AppendQueryIf<TValue>(bool condition, string name, TValue? value)
    {
        if (!condition)
            return this;
    ...
    /// <returns></returns>
    public UrlBuilderLegacy AppendQuery(string? queryString)
    {
    ...
    /// <returns></returns>
    public UrlBuilderLegacy SetQuery(string? queryString)
    {
        Query.Clear();
        if (queryString is null)
            return this;
    ...
    /// <summary>
    /// Creates a new <see cref="UrlBuilderLegacy"/> using the optional base path.
    /// </summary>
    /// <param name="baseUrl">The base path for the UrlBuilder</param>
    /// <returns>A new instance of UrlBuilder</returns>
    public static UrlBuilderLegacy Create(string? baseUrl = null) => new(baseUrl);
